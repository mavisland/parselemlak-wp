          ...
          array(
            ...
            'pages'               => array(
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', 'Tema Ayarları' ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', 'Tema Ayarları' ),
                'capability'      => $caps = apply_filters( 'ot_theme_options_capability', 'edit_theme_options' ),
                'menu_slug'       => apply_filters( 'ot_theme_options_menu_slug', 'weblebix-ayarlar' ),
                'icon_url'        => apply_filters( 'ot_theme_options_icon_url', null ),
                'position'        => apply_filters( 'ot_theme_options_position', 61 ),
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', 'Tama ayarları güncellendi.' ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', 'Tema ayarları sıfırlandı.' ),
                'button_text'     => apply_filters( 'ot_theme_options_button_text', 'Değişiklikleri Kaydet' ),
