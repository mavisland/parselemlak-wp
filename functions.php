<?php
/**
 * Parsel Emlak functions and definitions
 *
...
function parsel_setup() {
	 ...
	 * If you're building a theme based on Parsel Emlak, use a find and replace
	 * to change 'parsel' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'parsel', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'parsel' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'parsel_custom_background_args', array(
